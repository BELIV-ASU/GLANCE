...
DEFAULT_ADAPTER    = str(SCRIPT_DIR / "checkpoints" / "checkpoint-600")
DEFAULT_VAL_JSONL  = str(SCRIPT_DIR / "data_drivelm" / "val.jsonl")
...
def run_inference(args):
    ...
    # Save results
    out_path = os.path.join(SCRIPT_DIR, "inference_results_ckpt200.json")
