...
def main():
    ...
    parser.add_argument("--results", default=str(PROJECT_ROOT / "results" / "inference_results_ckpt200.json"),
                        help="Path to inference results JSON")
    parser.add_argument("--out_dir", default=str(PROJECT_ROOT / "results" / "viz_ckpt200"),
